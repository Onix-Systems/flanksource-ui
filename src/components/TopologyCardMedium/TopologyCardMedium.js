        ...
        <div className="flex w-med-card-right justify-between pl-1 pr-1.5 pb-3.5 pt-3">
          ...
          {selectionMode ? (
            ...
            <TopologyDropdownMenu
              ...
              menuButtonClassName="p-1.5 min-w-7 rounded-full hover:bg-gray-200 active:bg-gray-200 focus:outline-none focus-visible:ring-2  focus:ring-gray-200 focus-visible:ring-opacity-75"
