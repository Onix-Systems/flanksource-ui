    ...
    <div className="border border-gray-300 rounded-md flex flex-col">
      ...
      >
        <thead className="rounded-md sticky top-16 z-20">
          <tr className="px-6 py-3 grid grid-cols-7 gap-0 border-b border-gray-300 uppercase bg-lightest-gray rounded-t-md">
            <th
              className="text-gray-800 text-xs col-span-2 sticky top-0"
              scope="row"
            >
              Name
            </th>
            <th className="text-gray-400 text-xs sticky top-0">Severity</th>
            <th className="text-gray-400 text-xs sticky top-0">Status</th>
            <th className="text-gray-400 text-xs sticky top-0">Age</th>
            <th className="text-gray-400 text-xs col-span-2 sticky top-0">
              Responders
            </th>
          </tr>
        </thead>
...
function IncidentItem({ incident, ...rest }) {
  ...
  return (
    <Link to={`/incidents/${id}`} {...rest}>
      <tr className="px-6 py-3 grid grid-cols-7 items-center">
